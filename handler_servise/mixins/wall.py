...
class WallMixin:
    ...
    def on_wall_reply_new(self, o):
        ...
        db.insert("wall_reply", {
            ...
            "post_owner_id": o.get("post_owner_id"),
            "text": o.get("text", ""), "date": o.get("date", 0),
        })

    def on_wall_reply_edit(self, o):
        cid     = o.get("id")
        post_id = o.get("post_id")
        text    = o.get("text", "")[:80]
    ...
    def on_wall_reply_restore(self, o):
        cid     = o.get("id")
        post_id = o.get("post_id")
    ...
    def on_wall_reply_delete(self, o):
        cid     = o.get("id")
        post_id = o.get("post_id")
    ...
    def on_wall_schedule_post_new(self, o):
        pid  = o.get("id")
        date = o.get("schedule_time", 0)
        print(f"  🕐 Отложенный пост #{pid} запланирован на {_ts(date)}")
        db.insert("wall_schedule_post", {"id": pid, "schedule_time": date})

    def on_wall_schedule_post_delete(self, o):
        pid  = o.get("id")
        date = o.get("schedule_time", 0)
