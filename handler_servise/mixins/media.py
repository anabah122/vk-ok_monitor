...
class MediaMixin:
    ...
    def on_photo_comment_edit(self, o):
        cid      = o.get("id")
        photo_id = o.get("photo_id")
        text     = o.get("text", "")[:60]
    ...
    def on_photo_comment_restore(self, o):
        cid      = o.get("id")
        photo_id = o.get("photo_id")
    ...
    def on_photo_comment_delete(self, o):
        cid      = o.get("id")
        photo_id = o.get("photo_id")
    ...
    def on_video_new(self, o):
        ...
        db.insert("video", {
            "id": vid, "owner_id": owner,
            "title": title, "duration": dur, "date": o.get("date", 0),
        })

    def on_video_comment_new(self, o):
        cid      = o.get("id")
        from_id  = o.get("from_id")
    ...
    def on_video_comment_edit(self, o):
        cid      = o.get("id")
        video_id = o.get("video_id")
        text     = o.get("text", "")[:60]
    ...
    def on_video_comment_restore(self, o):
        cid      = o.get("id")
        video_id = o.get("video_id")
    ...
    def on_video_comment_delete(self, o):
        cid      = o.get("id")
        video_id = o.get("video_id")
        deleter  = o.get("deleter_id")
